...
echo [3/5] Configurando o projeto com CMake para gerar DLL (x86)...
cmake -G "Visual Studio 17 2022" -A Win32 -DBUILD_SHARED_LIBS=ON -DCMAKE_INSTALL_PREFIX=C:\devprg\pcre232 ..
