...
Begin VB.Form FrmFemeaPad 
   ...
   Begin NewTabCtl.NewTab SSTab1 
      ...
      Tab(0).Control(1)=   "CMDSIG(1)"
      Tab(0).Control(2)=   "Command6"
      Tab(0).Control(3)=   "CmdExpRPN"
      Tab(0).Control(4)=   "DIZAPU"
      Tab(0).Control(5)=   "CmdEdiRevi"
      Tab(0).Control(6)=   "Command5"
      Tab(0).Control(7)=   "CmdREvi"
      Tab(0).Control(8)=   "CmdMacSig(2)"
      Tab(0).Control(9)=   "CmdMacSig(1)"
      Tab(0).Control(10)=   "CmdMacSig(0)"
      Tab(0).Control(11)=   "CMDSIG(0)"
      Tab(0).Control(12)=   "txtFields(24)"
      Tab(0).Control(13)=   "CmdExpCau(2)"
      Tab(0).Control(14)=   "CmdExpCau(1)"
      Tab(0).Control(15)=   "CmdRenumerar(3)"
      Tab(0).Control(16)=   "CmdRenumerar(2)"
      Tab(0).Control(17)=   "CmdRenumerar(1)"
      Tab(0).Control(18)=   "CmdRenumerar(0)"
      Tab(0).Control(19)=   "CmdSev"
      Tab(0).Control(20)=   "CmdRem(3)"
      Tab(0).Control(21)=   "Command4"
      Tab(0).Control(22)=   "CmdRem(2)"
      Tab(0).Control(23)=   "CmdRem(1)"
      Tab(0).Control(24)=   "CmdRem(0)"
      Tab(0).Control(25)=   "CmdExpCau(0)"
      Tab(0).Control(26)=   "CmdNovo(0)"
      Tab(0).Control(27)=   "CmdNovo(1)"
      Tab(0).Control(28)=   "CmdNovo(2)"
      Tab(0).Control(29)=   "CmdNovo(3)"
      Tab(0).Control(30)=   "CmdEscPro"
      Tab(0).Control(31)=   "CmdEscFal"
      Tab(0).Control(32)=   "Cmdescefe"
      Tab(0).Control(33)=   "Command1"
      Tab(0).Control(34)=   "Retornar(0)"
      Tab(0).Control(35)=   "CmdExcCau"
      Tab(0).Control(36)=   "CmdExcEfe"
      Tab(0).Control(37)=   "CmdExcFal"
      Tab(0).Control(38)=   "CmdExcPro"
      Tab(0).Control(39)=   "GridPRO"
      Tab(0).Control(40)=   "GRIDFAL"
      Tab(0).Control(41)=   "gridefe"
      Tab(0).Control(42)=   "gridcau"
      Tab(0).Control(43)=   "gridrevcau"
      Tab(0).Control(44)=   "lblLabels(14)"
      Tab(0).Control(45)=   "Label1"
      Tab(0).Control(46)=   "Label2"
      Tab(0).Control(47)=   "Label3"
      Tab(0).Control(48)=   "Label4"
      Tab(0).Control(49)=   "dizpro(0)"
      Tab(0).Control(50)=   "dizfal(0)"
      Tab(0).Control(51)=   "dizefe"
      Tab(0).Control(52)=   "dizcau"
