...
Begin VB.Form frmPPAP 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(3)=   "lblLabels(9)"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "lblLabels(11)"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "lblLabels(24)"
      ...
      Tab(0).Control(10)=   "lblLabels(14)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "lblLabels(10)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "lblLabels(16)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "DTPicker3"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "DTPicker2"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "Txtfields(16)"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Txtfields(3)"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "Txtfields(4)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "Txtfields(7)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "Txtfields(11)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "ESCMC02A"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "check1(14)"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "Txtfields(10)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "check1(17)"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "Txtfields(9)"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "Txtfields(12)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "Txtfields(15)"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "check1(16)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "check1(19)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "check1(20)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "check1(18)"
      ...
      Tab(3).Control(0)=   "CmdEditar(0)"
      Tab(3).Control(1)=   "CmdExcluir(0)"
      Tab(3).Control(2)=   "CmdNovo(0)"
      Tab(3).Control(3)=   "Grid"
      Tab(3).ControlCount=   4
      TabCaption(4)   =   "Fornecedor"
      TabPicture(4)   =   "Frmppap.frx":0070
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Command9(1)"
      Tab(4).Control(1)=   "Command12"
      Tab(4).Control(2)=   "Command11"
      Tab(4).Control(3)=   "cmdcopcod"
      Tab(4).Control(4)=   "Cmdped"
      Tab(4).Control(5)=   "Cmdprg"
      Tab(4).Control(6)=   "Txtfields(28)"
      Tab(4).Control(7)=   "Txtfields(27)"
      Tab(4).Control(8)=   "Txtfields(26)"
      Tab(4).Control(9)=   "Txtfields(25)"
      Tab(4).Control(10)=   "Txtfields(24)"
      Tab(4).Control(11)=   "Command10"
      Tab(4).Control(12)=   "Command9(0)"
      Tab(4).Control(13)=   "Command8(2)"
      Tab(4).Control(14)=   "Command8(1)"
      Tab(4).Control(15)=   "Command8(0)"
      Tab(4).Control(16)=   "Txtfields(23)"
      Tab(4).Control(16).Enabled=   0   'False
      Tab(4).Control(17)=   "Txtfields(22)"
      Tab(4).Control(18)=   "Txtfields(21)"
      Tab(4).Control(19)=   "Command7"
      Tab(4).Control(20)=   "Command6"
      Tab(4).Control(21)=   "Cmdmw02"
      Tab(4).Control(22)=   "lblLabels(19)"
      Tab(4).Control(23)=   "lblLabels(18)"
      Tab(4).Control(24)=   "lblLabels(17)"
      Tab(4).ControlCount=   25
      TabCaption(5)   =   "Cron. Layout"
      TabPicture(5)   =   "Frmppap.frx":008C
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "CmdNovoLay(0)"
      Tab(5).Control(1)=   "CmdNovoLay(1)"
      Tab(5).Control(2)=   "CmdExcLay(1)"
      Tab(5).Control(3)=   "CmdEdilay(1)"
      Tab(5).Control(4)=   "gridlay"
      Tab(5).ControlCount=   5
      TabCaption(6)   =   "Cjto"
      TabPicture(6)   =   "Frmppap.frx":00A8
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "Cmdcjtcrn(0)"
      Tab(6).Control(1)=   "Cmdimppf(0)"
      Tab(6).Control(2)=   "CmdExcjto(2)"
      Tab(6).Control(3)=   "CmdNovCjto(2)"
      Tab(6).Control(4)=   "GridCjto"
