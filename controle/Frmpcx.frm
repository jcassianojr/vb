...
Begin VB.Form frmPCX 
   ...
   Begin NewTabCtl.NewTab SSTab1 
      ...
      Tab(20).Control(0)=   "PCDinigp12"
      Tab(20).Control(1)=   "escidfolha(12)"
      Tab(20).Control(2)=   "TXTgp12(10)"
      Tab(20).Control(3)=   "escidfolha(2)"
      Tab(20).Control(4)=   "Command1(2)"
      Tab(20).Control(5)=   "TXTgp12(14)"
      Tab(20).Control(6)=   "TXTgp12(11)"
      Tab(20).Control(7)=   "TXTgp12(12)"
      Tab(20).Control(8)=   "escpfela(2)"
      Tab(20).Control(9)=   "TXTgp12(13)"
      Tab(20).Control(10)=   "lblLabels(51)"
      Tab(20).Control(11)=   "lblLabels(50)"
      Tab(20).Control(12)=   "lblLabels(49)"
