...
Public Sub RegistrarLogSeguranca(ByVal cSQL As String)
    ...
    ' O par?metro 8 indica "ForAppending" (Adicionar ao final)
    ' O True indica que ele deve criar o arquivo caso ele n?o exista
...
Public Function Mana5Fec() As Boolean
  ...
  If Len(aARQFEC(0)) > 0 Or Len(aARQFEC(1)) > 0 Or Len(aARQFEC(2)) > 0 Or Len(aARQFEC(3)) > 0 Then
    ...
    End If
    If cCAMFEC = "C" Then
      If Not MDG("Usar Acumulo Anterior", "Confirma?ao") Then
